...
public enum RDCommandHex {
    ...
    RD_PART_POWER_ONE_MIN("c6 31"),
    RD_PART_POWER_ONE_MAX("c6 32"),
    RD_PART_POWER_TWO_MIN("c6 41"),
    RD_PART_POWER_TWO_MAX("c6 42"),
    RD_PART_POWER_THREE_MIN("c6 35"),
    RD_PART_POWER_THREE_MAX("c6 36"),
    RD_PART_POWER_FOUR_MIN("c6 37"),
    RD_PART_POWER_FOUR_MAX("c6 38"),
    RD_VELOCITY("c9 02"),
